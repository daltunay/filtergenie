...
class EbayScraper(BaseScraper):
    ...
    def extract_product_description(soup: BeautifulSoup) -> str:
        ...
        specs = soup.select('div.ux-layout-section__item .ux-labels-values__labels, .ux-labels-values__values')
        if specs:
    ...
    def extract_product_urls(soup: BeautifulSoup) -> list[str]:
        ...
        item_links = soup.select('li.s-item a.s-item__link, div.srp-results a.s-item__link')
